...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='PermissionFilmWork',
            fields=[
                ('created', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('film_work', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.filmwork')),
                ('permission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.permission', verbose_name='permission')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='filmwork',
            name='permissions',
            field=models.ManyToManyField(through='movies.PermissionFilmWork', to='movies.permission'),
        ),
        migrations.CreateModel(
            name='PersonFilmWork',
            fields=[
