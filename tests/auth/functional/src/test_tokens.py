...
from tests.auth.functional.testdata.tokens_data import (
    token_request_login,
...
from tests.auth.functional import del_query as del_query_user, del_history_query, user_super_data, role_super_data
