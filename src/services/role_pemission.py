...
class RolePermissionService:
    ...
    async def get_permissions_for_role(self, obj_uuid: UUID) -> ResponseRoleExtended:
...
def get_role_permission_service(
    ...
    return RolePermissionService(repository, role_repository, permission_repository)
